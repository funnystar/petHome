<template>
  <div>
    ...
    <div class="operation">
      ...
      <el-button type="danger" plain disabled="true" @click="delBatch">批量删除</el-button>
    </div>
      ...
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" width="180">
          <template v-slot="scope">
            ...
            <el-button size="mini" type="danger" disabled="true" plain @click="del(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
